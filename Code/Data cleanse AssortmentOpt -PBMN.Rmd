...
chocolate <- c("CHOC","COCOA")

full_11_12_13 <- full_11_12_13 %>% mutate(chunky = if_else(str_detect(full_11_12_13$upc_descr, "CHK"),1,0),
                                          ...
                                          honey = if_else(str_detect(full_11_12_13$upc_descr, "hny"),1,0),
                                          unsalted = if_else(str_detect(full_11_12_13$upc_descr, "uns"),1,0)) 

#Create necessary data structure before adding additional attributes from string search. 
full_11_12_13 <- full_11_12_13[,c("week_end","upc","upc_descr","units","price","avgprice","week","volume","price.vol","size1_amount", "sales", "feature", "display")]
