...
$|R_t| \in \left[0,1\right]$ is the determinant of the correlation matrix corresponding to the covariance matrix $|\Sigma_t|$.  The determinant of a correlation matrix lies on the $\left[0,1\right]$ interval where $1$ indicates that the correlations are equal to $0$.  As such, $\alpha_4$ captures the influence of assortment variety on category sales.  We expect the value of $\alpha_4$ to be positive, indicating that category sales increase as the variety of the assortment increases 
